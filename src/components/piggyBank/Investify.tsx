...
<Balance></Balance>
        ...
        <Savings>
            ...
            <Disp>Start investing in verified oppurtunities. Let's get you started.</Disp>

            <Butt onClick={toggle2}>INVEST NOW</Butt>

            <Butt style={{backgroundColor:"transparent", border:"1px solid #062863", color:"#062863", marginTop:"10px"}}>LEARN MORE</Butt>
